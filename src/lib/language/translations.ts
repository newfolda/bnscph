...
export const translations: Record<Language, Translation> = {
  en: {
    ...
    sellerTrust: {
      ...
      items: [
        { value: "5+ Years", title: "Car-Buying Experience", description: "Helping Filipino car owners sell through a professional and straightforward process since 2021." },
        { value: "1,000+", title: "Cars Purchased", description: "Completed transactions with vehicle owners across the Philippines." },
        { value: "2010 &", title: "Newer Models Accepted", description: "We consider vehicles from model year 2010 onward, subject to condition and inspection." },
  ...
  tgl: {
    ...
    sellerTrust: {
      ...
      items: [
        { value: "5+ Taon", title: "Karanasan sa Pagbili ng Sasakyan", description: "Tinutulungan ang mga Filipino car owner na maibenta ang kanilang sasakyan sa propesyonal at diretsong paraan mula 2021." },
        ...
        { value: "2010 &", title: "Mas Bagong Modelo ang Tinatanggap", description: "Isinasaalang-alang namin ang mga sasakyan mula model year 2010 pataas, depende sa kondisyon at inspection." },
