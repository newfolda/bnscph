        ...
        <div className="absolute inset-0 flex gap-8 px-6 pb-20 pt-7 sm:static sm:px-0 sm:pb-48 sm:pt-20 md:pb-52 lg:pb-60">
          <div className="flex flex-1 flex-col justify-center">
            ...
            <Button
              ...
              onClick={openSellCarModal}
              className="group mt-5 inline-flex h-[50px] w-full max-w-[16.625rem] items-center justify-between gap-4 border border-[#a97d1d]/80 !bg-[#D1A234] !pl-5 !pr-2 !text-white shadow-[0_6px_18px_rgba(0,0,0,0.16)] transition-[transform,box-shadow,background-color,border-color] duration-[240ms] ease-out hover:-translate-y-px hover:border-[#946d18] hover:!bg-[#C4962D] hover:shadow-[0_8px_22px_rgba(0,0,0,0.2)] active:translate-y-0 active:shadow-[0_5px_14px_rgba(0,0,0,0.14)] focus-visible:-translate-y-px focus-visible:border-[#946d18] focus-visible:!bg-[#C4962D] focus-visible:shadow-[0_8px_22px_rgba(0,0,0,0.2)] focus-visible:ring-2 focus-visible:ring-[#D1A234]/70 focus-visible:ring-offset-4 focus-visible:ring-offset-[var(--primary-light)] motion-reduce:hover:translate-y-0 motion-reduce:focus-visible:translate-y-0 motion-reduce:active:translate-y-0 sm:!grid sm:h-[56px] sm:grid-cols-[36px_minmax(0,1fr)_36px] sm:justify-normal sm:gap-0 sm:border-[#B8861F] sm:!bg-[#D4A53A] sm:!px-4 sm:shadow-[0_7px_20px_rgba(0,0,0,0.17)] sm:hover:border-[#B8861F] sm:hover:!bg-[#C9972B] sm:hover:shadow-[0_9px_24px_rgba(0,0,0,0.21)] sm:focus-visible:border-[#B8861F] sm:focus-visible:!bg-[#C9972B] sm:focus-visible:shadow-[0_9px_24px_rgba(0,0,0,0.21)] sm:focus-visible:ring-[#D4A53A]/70"
              style={{ borderRadius: "9999px" }}
            >
              <span className="flex min-w-0 flex-1 items-center whitespace-nowrap text-[13px] font-semibold uppercase tracking-[0.05em] text-white sm:col-start-2 sm:justify-self-center sm:text-[14px] sm:font-bold">
                <span className="sm:hidden">SELL MY CAR</span>
                <span className="hidden sm:inline">{t.hero.cta}</span>
              </span>
              <span aria-hidden="true" className="flex size-[34px] shrink-0 items-center justify-center rounded-full bg-white/15 text-white transition-[transform,background-color] duration-[240ms] ease-out group-hover:translate-x-0.5 group-hover:bg-white/20 group-focus-visible:translate-x-0.5 group-focus-visible:bg-white/20 motion-reduce:transition-none motion-reduce:group-hover:translate-x-0 motion-reduce:group-focus-visible:translate-x-0 sm:col-start-3 sm:size-[36px]">
                <svg className="sm:size-5" fill="none" height="18" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" viewBox="0 0 24 24" width="18">
