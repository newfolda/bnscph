...
const typewriterWords = ["hassle.", "headache."]
          ...
          <div className="flex flex-1 flex-col justify-center gap-7">
            ...
            <p aria-label="Maximum value. Zero hassle." className="max-w-md text-lg leading-relaxed text-[var(--text-secondary)]">
              ...
              <span aria-hidden="true" className="relative inline-block align-baseline text-[var(--primary-hover)]">
                <span className="invisible">headache.</span>
            ...
            <Button
              className="w-52 bg-[var(--primary)] px-6 py-4 font-semibold !text-[var(--text-primary)] shadow-lg hover:!bg-[var(--primary-hover)] hover:shadow-xl"
              style={{ borderRadius: "0.75rem" }}
            >
              Sell My Car
            </Button>
          </div>
          <div className="flex h-[440px] flex-1 items-center justify-end">
            <Image
              src="/images/hero/hero.png"
              alt=""
              width={3840}
              height={1140}
              className="h-auto w-[760px] max-w-none drop-shadow-2xl"
