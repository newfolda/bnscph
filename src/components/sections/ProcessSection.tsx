  ...
  return (
    ...
    >
      <Container className="relative -mt-12 sm:-mt-5 md:-mt-6 lg:-mt-8">
        <div
          className={`process-main-panel relative mx-auto max-w-[75rem] overflow-hidden rounded-[2.25rem] border border-white/80 bg-white px-7 py-7 shadow-[0_18px_42px_rgba(0,0,0,0.16),0_7px_18px_rgba(200,160,68,0.08)] ring-1 ring-white/30 transition-[transform,box-shadow] duration-300 ease-out will-change-transform hover:-translate-y-0.5 hover:shadow-[0_32px_72px_rgba(0,0,0,0.22),0_12px_28px_rgba(200,160,68,0.12)] motion-reduce:transform-none motion-reduce:transition-none sm:px-8 md:px-14 md:py-12 md:shadow-[0_28px_65px_rgba(0,0,0,0.20),0_10px_24px_rgba(200,160,68,0.10)] lg:px-16 lg:py-14${activeMobileCard !== null ? ` process-main-panel--active-${activeMobileCard + 1}` : ""}`}
        >
