    ...
    >
      ...
      <style>{`
        ...
        .benefits-preferred-text-streak {
          ...
          color: transparent;
          opacity: 0;
          background: linear-gradient(105deg, transparent 0%, transparent 36%, rgba(255, 255, 255, 0.2) 43%, rgba(255, 255, 255, 0.96) 50%, rgba(255, 241, 198, 0.6) 55%, transparent 63%, transparent 100%);
